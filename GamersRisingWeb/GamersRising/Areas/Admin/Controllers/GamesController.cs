...
namespace GamersRising.Areas.Admin.Controllers
{
    ...
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ActiveTourneys")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ActiveTourneys")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
